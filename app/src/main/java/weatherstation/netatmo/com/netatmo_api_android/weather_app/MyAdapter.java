...
public class MyAdapter extends ArrayAdapter<Measures> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(measures.getRain().equals("No data")){
